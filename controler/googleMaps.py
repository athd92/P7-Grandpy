...
class GoogleMaps:
    ...
    def get_geocode(self):
        ...
        try:
            ...
            streetCityName = geocode_result[0]['address_components'][4]['long_name']
            streetCitySecondName = geocode_result[0]['address_components'][5]['long_name']
            streetCityCountry = geocode_result[0]['address_components'][6]['long_name']

            address = streetNumber + ' ' + streetName + ' ' + streetCity + ' ' + streetComplement + ' ' + streetCityName + ' ' + streetCitySecondName + ' ' + streetCityCountry
