...
class Parser():
    ...
    def __init__(self, question):
        self.question = question  # json object
    ...
    def to_lower_string(self):
        ...
        self.lowerStringQuestion = unidecode.unidecode(self.question)
    ...
    def extract_question(self):
        ...
        liste = re.findall(
                r'\bcherch[a-zA-Z]*|\blocal[a-zA-Z]*|\bsitu[a-zA-Z]*\
                 |\badress[a-zA-Z]*|\btrouve[a-zA-Z]*', query)
